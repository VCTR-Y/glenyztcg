function Card({ image, title, price }) {
  return (
    <div className="flex flex-col justify-start items-center p-4 rounded-lg text-center border">
      <img src={image} alt={title} className="h-48 sm:h-64 md:h-80 lg:h-96 object-fill rounded-2xl shadow-[12px_12px_12px_rgba(0,0,0,0.8)] transition-transform duration-300 ease-in-out hover:scale-106 cursor-pointer"/>
