...
function Pack({ image, title, price }) {
  return (
    <div className="flex flex-col justify-start items-center p-4 rounded-lg text-center">
      <img src={image} alt={title} className="h-96 sm:h-80 md:h-88 lg:h-96 object-cover rounded-2xl shadow-[12px_12px_12px_rgba(0,0,0,0.8)] transition-transform duration-300 ease-in-out hover:scale-106 cursor-pointer"/>
